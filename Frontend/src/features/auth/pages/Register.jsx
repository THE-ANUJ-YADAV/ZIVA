    ...
    <span className="text-sky-200 font-medium"> worldwide.</span>
            ...
            <div className="w-full lg:w-[55%] relative flex flex-col items-center justify-center p-8 sm:p-12 overflow-hidden bg-white">
                ...
                <div className="absolute top-0 right-0 w-80 h-80 pointer-events-none">
                    <div className="absolute top-[-40px] right-[-20px] w-64 h-64 bg-[#D1E6FF] rounded-[40%_60%_70%_30%/40%_50%_60%_50%] opacity-80 z-0"></div>
                    <div className="absolute top-[20px] right-[-30px] w-48 h-48 bg-[#BFE0FF] rounded-[50%_50%_30%_70%/50%_40%_60%_50%] opacity-60 z-0"></div>
                </div>

                {/* ZIVA Logo Top Right */}
                <div className="absolute top-8 right-12 flex flex-col items-center z-10">
